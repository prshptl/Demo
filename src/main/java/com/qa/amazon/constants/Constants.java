...
public class Constants {
	...
	public final static String TESTDATA = "./src/main/resources/testdata/TestInputData.json";
	public final static String CONFIGPROP = "./src/main/resources/config/config.properties";
	public final static String LOGGER = "./src/main/java/com/qa/amazon/logger/log4j.properties";
